    ...
    <Box sx={{ display: "flex", gap:"10px", flexDirection:"column"}}>
          ...
          <Button
              sx={{
                  ...
                  marginTop: "24px",
                  "&:hover": {
                      background: invitedCode ? "white" : "black", // Adjust background color on hover
                      color: invitedCode ? "black" : "gray", // Adjust text color on hover
                      border: invitedCode ? "1px solid black" : "none" // Adjust border on hover
                  },
              }}
